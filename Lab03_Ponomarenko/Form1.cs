...
namespace Lab03_Ponomarenko
{
    public partial class Form1 : Form
    {
        ...
        void myShowToolTip(TextBox tB, byte[] arr)
        {
            ...
            toolTip_HEX.SetToolTip(tB, binarystring);
        }
        ...
        private void button_XOR_Click(object sender, EventArgs e)
        {
            ...
            {
                textBox_Key_IN.Text = "1";
                cipher = myCipher(textBox_P_IN, textBox_Key_IN, textBox_C_IN);
            }
            else
            {
                cipher = myCipher(textBox_P_IN, textBox_Key_IN, textBox_C_IN); //зашифрування
            }
